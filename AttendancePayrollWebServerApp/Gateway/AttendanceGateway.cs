...
{
    public class AttendanceGateway : Gateway
    {
        ...
        public async Task<int> CountPresentEmpByAttDate(DateTime? attendanceDate=null)
        {
            try
            {
                ...
                {
                  string Query = $"SELECT count(EmployeeId) from  Attendance WHERE Status='{'P'}' and AttendanceDate = '{attendanceDate}' ";
        ...
        public async Task<int> CountAbsentEmpByAttDate(DateTime? attendanceDate = null)
        {
            try
            {
                ...
                {
                    string Query = $"SELECT count(EmployeeId) from  Attendance WHERE Status='{'A'}' and AttendanceDate = '{attendanceDate}' ";
                    Command = new SqlCommand(Query, Connection);
                    Command.Parameters.AddWithValue("@attendanceDate", attendanceDate);
                    ConnectionOpen();
                    var result = await Command.ExecuteScalarAsync();
        ...
        public async Task<int> CountLateEmpByAttDate(DateTime? attendanceDate = null)
        {
            try
            {
                ...
                {
                    string Query = $"SELECT count(EmployeeId) from  Attendance WHERE Status='{'L'}' and AttendanceDate = '{attendanceDate}' ";
                    Command = new SqlCommand(Query, Connection);
                    Command.Parameters.AddWithValue("@attendanceDate", attendanceDate);
                    ConnectionOpen();
                    var result = await Command.ExecuteScalarAsync();
        ...
        public async Task<int> CountLeaveEmpByAttDate(DateTime? attendanceDate = null)
        {
            try
            {
                ...
                {
                    string Query = $"SELECT count(EmployeeId) from  Attendance WHERE Status in ('SL','CL','EL','ML') and AttendanceDate = '{attendanceDate}' ";
                    Command = new SqlCommand(Query, Connection);
                    Command.Parameters.AddWithValue("@attendanceDate", attendanceDate);
                    ConnectionOpen();
                    var result = await Command.ExecuteScalarAsync();
        ...
        public async Task<int> CountTotalEmpByAttDate(DateTime? attendanceDate = null)
        {
            try
            {
                ...
                {
                    string Query = $"SELECT count(EmployeeId) from  Attendance WHERE AttendanceDate = '{attendanceDate}' ";
                    Command = new SqlCommand(Query, Connection);
                    Command.Parameters.AddWithValue("@attendanceDate", attendanceDate);
                    ConnectionOpen();
                    var result = await Command.ExecuteScalarAsync();
        ...
        public async Task<int> CountTotalMaleEmpByAttDate(DateTime? attendanceDate = null)
        {
            try
            {
                ...
                {
                    string Query = $"SELECT count(a.EmployeeId) from  Attendance a,Employee e" +
        ...
        public async Task<List<Attendance>> GetAttendanceList(string condition = "")
        {
            try
            {
                if (condition == "")
                {
                    ...
                    Query = "select distinct AttendanceDate from Attendance";
                ...
                else
                {
                    ...
                    Query = "select distinct AttendanceDate from Attendance" + condition;
                    //Query = "SELECT * FROM Attendance WHERE " + condition;
                }
        ...
        public async Task<int> CountAttenDanceDateByAttDate(DateTime? attendanceDate = null)
        {
            try
            {
                ...
                {
                    string Query = $"SELECT count(AttendanceDate) from  Attendance WHERE AttendanceDate = '{attendanceDate}' ";
                    Command = new SqlCommand(Query, Connection);
                    Command.Parameters.AddWithValue("@attendanceDate", attendanceDate);
                    ConnectionOpen();
                    var result = await Command.ExecuteScalarAsync();
