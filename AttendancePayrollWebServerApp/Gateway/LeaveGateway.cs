    ...
    public class LeaveGateway : Gateway
    {
        ...
        public async Task<Alert> Delete(int leaveId, string condition = "")
        {
            try
            {
                if (condition == "")
                {
                    Query = "DELETE Leave WHERE LeaveId = @leaveId";
                }
                else
                {
                    Query = "DELETE Leave WHERE " + condition;
                }
        ...
        public async Task<bool> IsExist(string condition = "")
        {
            try
            {
                if (condition == "")
                {
                    Query = "SELECT 1 FROM Leave";
                }
                else
                {
                    Query = "SELECT 1 FROM Leave WHERE " + condition;
                }
        ...
        public async Task<Leave> GetLeave(int leaveId, string condition = "")
        {
            try
            {
                ...
                {
                    Query = "SELECT * FROM Leave WHERE " + condition;
                }
        ...
        public async Task<List<Leave>> GetLeaveListMinCol(string columns, string condition = "")
        {
            try
            {
                if (condition == "")
                {
                    Query = "SELECT " + columns + " FROM Leave";
                }
                else
                {
                    Query = "SELECT " + columns + " FROM Leave WHERE " + condition;
                }
        ...
        public async Task<int> SumIssuedDaysCL(string employeeId)
        {
            try
            {
                Query = "SELECT SUM(IssuedDays) FROM Leave WHERE EmployeeId = @employeeId AND LeaveType ='CL'";
                Command = new SqlCommand(Query, Connection);
        ...
        public async Task<int> SumIssuedDaysSL(string employeeId)
        {
            try
            {
                Query = "SELECT SUM(IssuedDays) FROM Leave WHERE EmployeeId = @employeeId AND LeaveType ='SL'";
                Command = new SqlCommand(Query, Connection);
                Command.Parameters.AddWithValue("@employeeId", employeeId);
                // Command.Parameters.AddWithValue("@leaveType", leaveType);
                ConnectionOpen();
        ...
        public async Task<int> SumIssuedDaysEL(string employeeId)
        {
            try
            {
                Query = "SELECT SUM(IssuedDays) FROM Leave WHERE EmployeeId = @employeeId AND LeaveType ='EL'";
                Command = new SqlCommand(Query, Connection);
                Command.Parameters.AddWithValue("@employeeId", employeeId);
                // Command.Parameters.AddWithValue("@leaveType", leaveType);
                ConnectionOpen();
        ...
        public async Task<Leave> GetMaxLeaveByEmpId(string employeeId, string condition = "")
        {
            try
            {

                Query = " select * from Leave where LeaveId=(select max(LeaveId) from Leave where EmployeeId= @employeeId)";
                //if (condition == "")
                //{
                //    Query = "SELECT * FROM Leave WHERE LeaveId = @leaveId";
                //}
        ...
        public async Task<Leave> GetAllLeaveByEmpId(string employeeId, string condition = "")
        {
            try
            {

                Query = " select * from Leave where EmployeeId= @employeeId)";
        ...
        public async Task<int> CountEmpId(string employeeId)
        {
            try
            {
                Query = "SELECT COUNT(EmployeeId) FROM Leave WHERE EmployeeId = @employeeId ";
                Command = new SqlCommand(Query, Connection);
                Command.Parameters.AddWithValue("@employeeId", employeeId);
                // Command.Parameters.AddWithValue("@leaveType", leaveType);
                ConnectionOpen();
            ...
            {
                throw new Exception($"Failed To Sum IssuedDays \n" + exception.Message);
            }
            finally
            {
                ConnectionClose();
        ...
        public async Task<int> SumIssuedDays(string employeeId, string leaveType)
        {
            try
            {
                Query = "SELECT SUM(IssuedDays) FROM Leave WHERE EmployeeId = @employeeId AND LeaveType = @leaveType";
                Command = new SqlCommand(Query, Connection);
                Command.Parameters.AddWithValue("@employeeId", employeeId);
                Command.Parameters.AddWithValue("@leaveType", leaveType);
                ConnectionOpen();
